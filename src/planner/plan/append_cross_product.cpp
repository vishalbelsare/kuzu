...
void JoinOrderEnumerator::appendCrossProduct(common::AccumulateType accumulateType, LogicalPlan& probePlan, LogicalPlan& buildPlan) {
    auto crossProduct =
        make_shared<LogicalCrossProduct>(accumulateType, probePlan.getLastOperator(), buildPlan.getLastOperator());
